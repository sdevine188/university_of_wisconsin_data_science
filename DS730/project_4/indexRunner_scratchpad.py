...
# args will be passed to python script on hortonworks via command line
#./args.py one two three

#args.py script is below:
#import sys
#print(sys.argv[1] + " " + sys.argv[2] + " " + sys.argv[3])

# specifically run with:
#./indexRunner.py proj_4_input proj_4_output 100 

# set wd for testing
os.chdir("C:/Users/Stephen/Desktop/University of Wisconsin/classes/DS730/project_4")
os.getcwd()

# set arguments for testing
input_folder = "proj_4_input"
output_folder = "proj_4_output"
page_character_count = 100
...
def get_word_index(input_folder_path, input_file_name, output_folder_path, page_character_count):
        ...
        current_output_file_name = output_folder_path + "/" + input_file_name
